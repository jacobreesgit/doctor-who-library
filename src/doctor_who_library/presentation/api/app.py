...
from doctor_who_library.presentation.api.routes.enrichment import router as enrichment_router
from doctor_who_library.presentation.api.routes.enrichment_display import router as enrichment_display_router
...
def create_app() -> FastAPI:
    ...
    async def custom_exception_handler(request: Request, exc: DoctorWhoLibraryException):
