...
class SectionValidationService:
    ...
    def get_section_category(self, section_name: str) -> Optional[SectionCategory]:
        """
    ...
    def find_similar_section_names(self, section_name: str, max_results: int = 5) -> List[str]:
        """
        ...
        for approved_name in self._approved_names:
            ...
            if (section_name_lower in approved_name.lower() or 
                approved_name.lower().startswith(section_name_lower)):
    ...
    def get_validation_error_message(self, section_name: str) -> str:
        ...
        if similar_names:
            ...
            message += f". Must be one of the approved section names."
